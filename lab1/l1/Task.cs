...
namespace l1
{
    public static class Task
    {
        ...
        {
            Console.WriteLine($"Экономия изменится на {A_1B[1, 0] * 5}\n");
        }
        ...
        {
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 11 * A_1B[1, 0] + 20 * A_1B[2, 0]}");
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 19 * A_1B[1, 0] + 14 * A_1B[2, 0]}");
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 13 * A_1B[1, 0] + 12 * A_1B[2, 0]}");
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 14 * A_1B[1, 0] + 8 * A_1B[2, 0]}");
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 11 * A_1B[1, 0] + 10 * A_1B[2, 0]}");
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 17 * A_1B[1, 0] + 6 * A_1B[2, 0]}");
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 23 * A_1B[1, 0] + 16 * A_1B[2, 0]}");
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 11 * A_1B[1, 0] + 15 * A_1B[2, 0]}");
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 13 * A_1B[1, 0] + 8 * A_1B[2, 0]}");
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 20 * A_1B[1, 0] + 17 * A_1B[2, 0]}");
            Console.WriteLine($"Экономия изменится на {A_1B[0, 0] + 1.1 * 15 * A_1B[1, 0] + 12 * A_1B[2, 0]}\n");
        }
